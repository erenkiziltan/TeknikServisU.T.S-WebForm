<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TeknikServis.Web.Default" %>
...
<head>
    ...
    <title>Teknik Servis / Anasayfa</title>
...
<body>
    <div class="sidenav">
		...
		<div class="col-4 side_top_left">
			<img src="web/images/Ts1.png" alt="news image" class="img-fluid navimg">
		</div>
        ...
        <div class="banner-text-w3ls">
            <div class="container">
                <div class="mx-auto text-center">
                    <h1>En ucuz fiyatlarla en uygun yüzlerce ürün bir tıkla kapınızda .</h1>
					<p class="banp mx-auto mt-3"> 24 Farklı kategoride yüzlerce farklı ürünle sizlerleyiz.  </p>
...
<section class="slide-wrapper" id="about">
	...
	<img src="web/images/hakkimizda.png" style=" width:250px" class ="img-fluid" alt="">
	<p class="iner mt-5">
    ...
    <div class="wthree_pvtits-services align-w3" id="services">
        <div class="container">
            <div class="wthree_pvt_title text-center">
                ...
                <p class="main_p mb-5  text-center mx-auto"> Mağazamızdan almış olduğunuz ürünlerde herhangi bir teknik problem oluşursa 2 yıl süreyle herhangi bir ücret ödemeden
                    tamir ve onarım işlerinizi yapmaktayız.
                </p>
                <a class="btn btn-primary mt-lg-5 mt-3 agile-link-bnr" href="WebForm1.Aspx" style="background-color:aqua" role="button">Arızalı Ürün Takibi </a>
            </div>
            <div class="wthree_pvtits-services-row row">
                ...
                <div class="col-lg-4 col-md-6  wthree_sgrid  py-sm-5 py-4">
                    ...
                    <h4 class="my-3">%98 Müşteri Memnuniyeti</h4>
                </div>
                <div class="col-lg-4 col-md-6  wthree_sgrid   py-sm-5 py-4">
...
<!-- contact -->
	 <section class="wedo" id="contact">
		   ...
		   <p class="main_p mb-5  text-center mx-auto">Mağazamız ya da aldığınız herhangi bir ürüne dair bir sorun oluşursa 
               bize aşağıdaki panalden mesaj atarak ulaşabilirsiniz.</p>
		   <div class="contact_grid_right mt-5 mx-auto text-center">
				<form action="#" method="post" runat ="server">
					<div class="row contact_top">
						...
						<div class="col-sm-6">
						 ...
						 <asp:TextBox ID="TextBox4" TextMode="MultiLine" Height="50px" runat="server" placeholder="Mesajınız"></asp:TextBox>
			...
			<div class="follow">
				...
				<p>© 2022 Teknik Servis ve Ürün Takip
